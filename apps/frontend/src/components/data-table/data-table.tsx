  ...
  return (
    <div className={`flex flex-col h-full space-y-0`}>
      ...
      <div className="flex-1 border border-border/50 shadow-sm overflow-hidden bg-card flex flex-col mb-3">
        <div className="overflow-auto max-h-[60vh] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                ...
                >
                  {headerGroup.headers.map((header) => {
                    return (
                      <th
                        key={header.id}
                        className="h-8 px-2 text-left align-middle font-semibold text-muted-foreground whitespace-nowrap"
                      >
