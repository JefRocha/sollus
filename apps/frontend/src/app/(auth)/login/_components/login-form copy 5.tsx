    ...
    <>
      ...
      <div className="min-h-screen w-full flex items-center justify-center relative p-4">
        ...
        <Card className="w-full max-w-3xl relative z-10 border-slate-800 bg-slate-900/80 backdrop-blur-2xl shadow-2xl shadow-black/50">
          ...
          <CardHeader className="space-y-3 pb-4 pt-6 px-10 border-b border-slate-800/50 bg-gradient-to-b from-slate-800/50 to-transparent">
            <div className="flex flex-col items-center gap-2">
              <div className="relative">
                ...
                <div className="relative w-12 h-12 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg">
                  <Lock className="w-6 h-6 text-white" strokeWidth={2.5} />
                </div>
              </div>
              <div className="text-center space-y-0.5">
                <CardTitle className="text-xl font-bold bg-gradient-to-r from-white via-slate-100 to-slate-300 bg-clip-text text-transparent">
                  Sollus ERP
                </CardTitle>
          ...
          <CardContent className="p-6 pb-4">
            <Form {...form}>
              <div className="space-y-3">
                      ...
                      <FormControl>
                        <div className="relative group">
                          ...
                          <Input
                            ...
                            {...field}
                            className="relative pl-11 h-10 bg-slate-800/50 border-slate-700 text-white placeholder:text-slate-500 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all"
                          />
                        </div>
                      </FormControl>
                ...
                {errorMsg && (
                  <div className="flex items-center gap-3 p-3 text-sm text-red-200 bg-red-500/10 border border-red-500/20 rounded-lg backdrop-blur-sm">
                ...
                <div className="pt-0.5 space-y-2.5">
                  <Button
                    ...
                    className="relative w-full h-10 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:via-purple-500 hover:to-pink-500 text-white font-semibold shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:shadow-indigo-500/40 transition-all duration-300 overflow-hidden group"
          ...
          <CardFooter className="justify-center text-xs text-slate-500 border-t border-slate-800/50 py-3 bg-slate-900/50">
