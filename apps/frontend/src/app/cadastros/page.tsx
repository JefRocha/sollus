...
export default function Page() {
  const items = [
    {
      label: "Cadastros",
      href: "/cadastros/dashboard",
      icon: Users,
      desc: "Pessoas, produtos e mais",
    },
    {
      label: "Movimento",
      href: "/dashboard",
      icon: Activity,
      desc: "Fluxos e operações",
    },
    {
      label: "Financeiro",
      href: "/financeiro",
      icon: Banknote,
      desc: "Contas e recebíveis",
    },
    {
      label: "CRM",
      href: "/crm",
    ...
    },
    {
      ...
      href: "/vendas",
      icon: ShoppingCart,
      desc: "Pedidos e faturamento",
    },
    {
      label: "Estoque",
      href: "/estoque",
      icon: Boxes,
      desc: "Movimentações e saldos",
    },
  ];
              ...
              <Card className={idx === 0 ? "ring-1 ring-primary/30" : ""}>
                ...
                <CardContent>
                  <div className="text-sm text-muted-foreground">
                    Acesse funcionalidades do módulo {it.label}.
                  </div>
                </CardContent>
              </Card>
            </Link>
