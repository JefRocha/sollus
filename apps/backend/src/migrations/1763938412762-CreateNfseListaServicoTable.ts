...
export class CreateNfseListaServicoTable1763938412762 implements MigrationInterface {
    name = 'CreateNfseListaServicoTable1763938412762'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Criar tabela NFSE_LISTA_SERVICO
        await queryRunner.query(`CREATE TABLE "NFSE_LISTA_SERVICO" (
            "id" SERIAL NOT NULL,
            "CODIGO" character(5),
            "DESCRICAO" text,
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "NFSE_LISTA_SERVICO"`);
    }
