...
export class CboController implements CrudController<Cbo> {
  ...
  @Override()
  createOne(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Cbo) {
    console.log('[CboController] createOne called with:', dto);
    return this.service.createOne(req, dto);
  }

  @Override()
  updateOne(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Cbo) {
    console.log('[CboController] updateOne called with:', dto);
    return this.service.updateOne(req, dto);
  }

  @Override()
  replaceOne(@ParsedRequest() req: CrudRequest, @ParsedBody() dto: Cbo) {
